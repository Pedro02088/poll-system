    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl shadow-xl shadow-slate-200/60 border border-slate-100">
          <h2 className="text-xl font-bold text-slate-800 mb-2">Nova senha</h2>
          <p className="text-slate-500 text-sm mb-6">Defina a nova senha para <strong>{email}</strong>.</p>
